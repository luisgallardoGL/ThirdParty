import { Component, Input, Output, ViewChild, EventEmitter, ElementRef, HostBinding, HostListener, Renderer, forwardRef } from '@angular/core';
import { Keys } from '../common/enums';
import { createMaxValidator } from '../common/max.validator';
import { createMinValidator } from '../common/min.validator';
import { NG_VALUE_ACCESSOR, NG_VALIDATORS } from '@angular/forms';
import { IntlService } from '@progress/kendo-angular-intl';
/**
 * Represents the Kendo UI NumericTextBox component for Angular 2.
 */
export var NumericTextBoxComponent = (function () {
    ...
    NumericTextBoxComponent.propDecorators = {
        ...
        'spinners': [{ type: Input },],
        'round': [{ type: Input },],
        'restrictDecimals': [{ type: Input },],
        'value': [{ type: Input },],
        'valueChange': [{ type: Output },],
        'focus': [{ type: Output },],
        'blur': [{ type: Output },],
        'numericInput': [{ type: ViewChild, args: ['numericInput',] },],
        'hostBlur': [{ type: HostListener, args: ['blur',] },],
        'widgetClass': [{ type: HostBinding, args: ['class.k-widget',] },],
        'numericClass': [{ type: HostBinding, args: ['class.k-numerictextbox',] },],
