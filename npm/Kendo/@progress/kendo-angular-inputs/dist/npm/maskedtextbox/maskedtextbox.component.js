...
var pattern_validator_1 = require('../common/pattern.validator');
...
var MaskedTextBoxComponent = (function () {
    function MaskedTextBoxComponent(element, renderer) {
         ...
         */
        this.focus = new core_2.EventEmitter();
        /**
         * Fires each time the input element gets blurred.
         */
        this.blur = new core_2.EventEmitter();
        this.focused = false;
        this.innerValue = '';
        this.innerMask = '';
        this.isDel = false;
    ...
    MaskedTextBoxComponent.prototype.updateValidator = function () {
        ...
        this.patternValidateFn = pattern_validator_1.createPatternValidator(pattern);
    };
    ...
    MaskedTextBoxComponent.decorators = [
        { type: core_1.Component, args: [{
                    ...
                    providers: [
                        { provide: forms_1.NG_VALUE_ACCESSOR, useExisting: core_1.forwardRef(function () { return MaskedTextBoxComponent; }), multi: true },
                        { provide: forms_1.NG_VALIDATORS, useExisting: core_1.forwardRef(function () { return MaskedTextBoxComponent; }), multi: true } /* tslint:disable-line */
                    ],
    ...
    MaskedTextBoxComponent.propDecorators = {
        ...
        'focus': [{ type: core_2.Output },],
        'blur': [{ type: core_2.Output },],
        'input': [{ type: core_1.ViewChild, args: ['input',] },],
        'mask': [{ type: core_1.Input },],
        'value': [{ type: core_1.Input },],
        'rules': [{ type: core_1.Input },],
        'prompt': [{ type: core_1.Input },],
        'keydown': [{ type: core_2.HostListener, args: ['keydown', ['$event'],] },],
        'paste': [{ type: core_2.HostListener, args: ['paste', ['$event'],] },],
        'widgetClass': [{ type: core_2.HostBinding, args: ['class.k-widget',] },],
        'textBoxClass': [{ type: core_2.HostBinding, args: ['class.k-textbox',] },],
        'maskedTextBoxClass': [{ type: core_2.HostBinding, args: ['class.k-maskedtextbox',] },],
    };
