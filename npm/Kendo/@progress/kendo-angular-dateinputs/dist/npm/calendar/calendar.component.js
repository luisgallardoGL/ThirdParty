...
var CalendarComponent = (function () {
    function CalendarComponent(element, navigator, renderer, scrollSyncService) {
         ...
         */
        this.focusedDate = kendo_date_math_1.getDate(new Date());
        /**
        ...
        this._min = new Date(dates_model_1.MIN_DATE);
        this._max = new Date(dates_model_1.MAX_DATE);
    ...
    Object.defineProperty(CalendarComponent.prototype, "min", {
         ...
         */
        set: function (min) {
            this._min = min || new Date(dates_model_1.MIN_DATE);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(CalendarComponent.prototype, "max", {
         ...
         */
        set: function (max) {
            this._max = max || new Date(dates_model_1.MAX_DATE);
        },
        enumerable: true,
        configurable: true
    });
    ...
    CalendarComponent.prototype.ngOnChanges = function (changes) {
        this.verifySettings();
        var useValue = changes.value && changes.value.currentValue && !changes.focusedDate;
