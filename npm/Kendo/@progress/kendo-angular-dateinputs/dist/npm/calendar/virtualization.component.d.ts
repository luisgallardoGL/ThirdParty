import { EventEmitter, ElementRef, OpaqueToken, OnChanges, OnDestroy, OnInit, AfterViewInit, Renderer, NgZone } from '@angular/core';
...
export declare class VirtualizationComponent implements OnChanges, OnInit, OnDestroy, AfterViewInit, Scrollable {
    ...
    constructor(scrollerFactory: any, container: ElementRef, dom: DOMService, renderer: Renderer, zone: NgZone);
