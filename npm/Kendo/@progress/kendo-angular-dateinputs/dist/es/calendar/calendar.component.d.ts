import { EventEmitter, ElementRef, AfterViewChecked, OnChanges, OnDestroy, Renderer } from '@angular/core';
...
export declare class CalendarComponent implements ControlValueAccessor, OnChanges, OnDestroy, AfterViewChecked, Validator {
     ...
     */
    enter(): void;
    constructor(element: ElementRef, navigator: NavigationService, renderer: Renderer, scrollSyncService: ScrollSyncService);
