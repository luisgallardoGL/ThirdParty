 ...
 */
exports.translateAggregateResults = function (data) {
    if (data === void 0) { data = []; }
    return (data.reduce(function (acc, x) { return set(x.Member, acc, set(x.AggregateMethodName.toLowerCase(), acc[x.Member] || {}, x.Value)); }, {}));
};
