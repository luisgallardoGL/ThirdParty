...
/**
 * Represents the result of [aggregate operation]({% slug api_kendo-data-query_aggregateby_kendouiforangular %}).
 * Where the keys are the field name used for the calculation and the values
 * are an object with the aggregate function name and resulting value.
 *
 * @example
 * ```js
